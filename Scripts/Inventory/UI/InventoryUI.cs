...
public class InventoryUI : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		Debug.Log($"Found {slots.Count} slots in InventoryUI");
	}

	private void Start()
	{
		inventory = SimulationController.Instance.player.inventory;
		if (inventory != null)
		{
		...
		{
			Debug.LogError($"Could not find inventory '{inventoryName}' through SimulationController");
		}
	}
	...
	public void Refresh()
	{
		Debug.Log("Refresh called on InventoryUI");
